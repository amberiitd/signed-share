...
}>({ navigationOff: false, setNavigationOff: () => {}, searchText: "", setSearchText: () => {}, userDataQuery: {loading: false}, setUserDataQuery: () => {} });
const PageContextProvider: FC<{ children: any }> = ({ children }) => {
	...
	return (
		<PageContext.Provider
			value={{ searchText, setSearchText, userDataQuery, setUserDataQuery, navigationOff, setNavigationOff }}
		>
            {children}
        </PageContext.Provider>
	);
